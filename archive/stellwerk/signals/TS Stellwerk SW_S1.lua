-------------------------------------------------------------------------------
-- TS Stellwerk SW_S1 – Wrapper fuer EIN HL-Hauptsignal (Object Name = SW_S1)
-- Strecken-Editor: Script = TS Stellwerk SW_S1.lua, dann STRECKE SPEICHERN
-- Aspect: 0 = Hp0, 1 = Hp1, 4 = Sh1
-------------------------------------------------------------------------------
